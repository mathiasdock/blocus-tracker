...
| `notification_settings` | singleton: `reminders_weekly_cap` (1–7, default 3) — v62 |
...
> segment), résultat par destinataire. Rappel du soir : Vercel Cron
> (`vercel.json`, 18:00 UTC), un rappel par membre et par jour dans SON
> fuseau, jamais entre 22 h et 8 h chez lui, plafond de relances sur 7 jours
> (l'examen du lendemain n'est pas plafonné) ; relancer le cron le même jour ne
> renvoie rien. Test à blanc : `GET /api/push/daily?dry=1` avec
