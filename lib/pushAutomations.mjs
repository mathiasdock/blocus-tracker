...
// part : lib/server/dailyReminders.mjs, lib/server/friendRequestPush.mjs),
...
export const AUTOMATIONS = [
  ...
  {
    // 49 % des inscrits sans ami ne reviennent jamais apres leur premier jour :
    // c'est la plus grosse fuite mesuree. Cette relance vise exactement ce
    // moment, une seule fois, trois jours apres l'inscription.
    key: "comeback_day3",
    category: "reminder",
    label: { fr: "Relance des nouveaux", en: "New member comeback" },
    trigger: { fr: "Trois jours après l'inscription, à qui n'a pas étudié depuis", en: "Three days after signup, to anyone who hasn't studied since" },
    vars: [],
    title: { fr: "Ton premier bloc t'attend 👋", en: "Your first block is waiting 👋" },
    body: { fr: "25 minutes suffisent pour lancer la machine. On commence ?", en: "25 minutes is enough to get going. Shall we?" },
    url: "/dashboard",
  },
  {
    key: "nudge_planning",
