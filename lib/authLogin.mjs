...
export function classifyAuthError(error) {
  ...
  // Compte suspendu par un admin (bannissement Supabase Auth, voir
  // /api/admin/members/[id]/suspension) : ni un mauvais mot de passe, ni une
  // panne — la personne doit le savoir.
