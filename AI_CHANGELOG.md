...
L'aperçu Open Graph 1200×630 abandonne le fond dégradé, l'horloge fantôme et les barres verticales décoratives. La nouvelle composition reprend le canevas crème, une seule surface d'encre, les polices locales, le vrai logo et huit Study Blocks horizontaux : sept quarts d'heure étudiés sur un objectif de deux heures. La mascotte Focus est rendue directement depuis `components/Mascot.js` et se tient au seuil de progression, sans illustration dupliquée ni faux écran produit. L'URL de l'image Open Graph est versionnée pour forcer les plateformes de partage à récupérer le nouveau rendu.
