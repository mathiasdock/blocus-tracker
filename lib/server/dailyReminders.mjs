...
export function createActivityLoader(db) {
  return async function loadActivity(now) {
    ...
    // Séries en cours (une session ces 3 derniers jours) : leur historique
    // complet, pour compter la série comme Stats, jokers compris.
 ...
 * @param loadActivity(now) → { sessions, exams, newcomers, frozenDays, configured }
