...
// 20 levels with non-decreasing gaps. Thresholds only ever move DOWN from a
...
// n'avaient jamais été atteints. Le sommet vaut désormais 20 000 XP (~250 h
// une fois cumulés badges, missions et objectifs) — chaque palier redevient
// atteignable. Doit rester synchronisé avec gamification_level_threshold().
export const LEVELS = [
 ...
 * – 10 XP per day of the BEST streak ever reached
 ...
 */
export function computeTotalXP({ totalMinutes, completedObjectives, bestStreak, examCount, badgeCount, bonusXP = 0 }) {
  return (
