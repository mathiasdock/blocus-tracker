export const COUNTRIES = [
  ...
  {
    // Premier État couvert aux États-Unis : la Floride, via les 12 membres du
    // State University System of Florida. Le bloc est volontairement "US" et
    // non "Floride", pour accueillir d'autres États sans restructurer.
    // Sélection éditoriale et logos historiques. Les nouveaux établissements
    // sont désormais créés à la demande dans study_spaces, sans migration.
    code: "US",
    name: "États-Unis 🇺🇸",
    universities: [
      // Sigles plutôt que noms courts : « Florida », « Florida State » et
      // « South Florida » côte à côte se confondaient, et ce sont de toute
      // façon les formes qu'emploient les étudiants sur place.
      { id: "UF",      name: "UF",             full: "University of Florida",             color: "#0021a5", logo: "/logos-commu/uf.webp" },
      { id: "FSU",     name: "FSU",            full: "Florida State University",          color: "#782f40", logo: "/logos-commu/fsu.webp" },
      { id: "USF",     name: "USF",            full: "University of South Florida",       color: "#006747", logo: "/logos-commu/usf.webp" },
      { id: "UCF",     name: "UCF",            full: "University of Central Florida",     color: "#a16207", logo: "/logos-commu/ucf.webp" },
      { id: "FIU",     name: "FIU",            full: "Florida International University",  color: "#081e3f", logo: null },
      { id: "FAU",     name: "FAU",            full: "Florida Atlantic University",       color: "#003366", logo: null },
      { id: "FAMU",    name: "FAMU",           full: "Florida A&M University",            color: "#046a38", logo: null },
      { id: "UNF",     name: "UNF",            full: "University of North Florida",       color: "#005a9c", logo: null },
      { id: "UWF",     name: "UWF",            full: "University of West Florida",        color: "#004c97", logo: null },
      { id: "FGCU",    name: "FGCU",           full: "Florida Gulf Coast University",     color: "#00573f", logo: null },
      { id: "NEWCOLL", name: "New College",    full: "New College of Florida",            color: "#0e7490", logo: null },
      { id: "FLPOLY",  name: "Florida Poly",   full: "Florida Polytechnic University",    color: "#4c1d95", logo: null },
    ],
  },
];
...
// profiles.university stores the full name ("Université catholique de
// Louvain"). A profile line shows the name students actually use
// ("UCLouvain"); a free-text institution unknown to the list stays as written.
export function universityShortName(full) {
  if (!full) return "";
  const match = ALL_UNIVERSITIES.find(u => u.full === full);
