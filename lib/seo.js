...
const configuredSiteUrl = (process.env.NEXT_PUBLIC_SITE_URL || PRODUCTION_SITE_URL).replace(/\/+$/, "");
...
export const PAGE_SEO = {
  ...
  "/messages": {
    title: "Messages, amis et groupes | Blocus Tracker",
    description: "Échange avec tes amis, groupes d'étude et communautés dans l'espace social Blocus Tracker.",
    index: false,
  },
  "/communautes": {
  ...
  return [
    ...
    },
    {
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "Blocus Tracker est-il gratuit ?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Oui. Tu peux tester le chrono gratuitement en mode découverte. Un compte permet surtout de sauvegarder tes données et ta progression.",
          },
        },
        {
          "@type": "Question",
          name: "Faut-il un compte pour utiliser le chrono ?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Non pour essayer le chrono. Oui pour conserver tes statistiques, ton planning, tes amis, tes badges et ton profil.",
          },
        },
        {
          "@type": "Question",
          name: "À qui s'adresse Blocus Tracker ?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Blocus Tracker s'adresse aux étudiants qui veulent structurer leurs révisions, mesurer leur temps d'étude et rester réguliers pendant les périodes de blocus ou d'examens.",
          },
        },
      ],
    },
