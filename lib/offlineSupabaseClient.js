  ...
  for (let d = 2; d <= 240; d++) {
    ...
    for (let k = 0; k < nb; k++) {
      ...
      rows.push({
        ...
        course_id: courses[rng() > 0.45 ? 0 : 1],
...
export const offlineSupabase = {
  ...
  rpc(name, params = {}) {
    ...
    if (name === "get_my_daily_missions" || name === "get_my_weekly_missions") {
      ...
      if (name === "get_my_daily_missions") {
        ...
        return Promise.resolve({ data: [
          { mission_id: "m_least_studied", label_key: "xp.m_least_studied", xp: 40,
            ...
            params: { course: "Biologie", target: 20, course_id: "offline-course-2" } },
          ...
          { mission_id: "c_beat_yesterday", label_key: "xp.c_beat_yesterday", xp: 50,
            done: todayMin > yesterdayMin, kind: "challenge",
            params: { minutes: yesterdayMin, target: yesterdayMin + 1 } },
        ], error: null });
      }
      ...
      const rows = [
        { mission_id: "w_hours", label_key: "xp.w_hours", target: 480,
