...
const SOUND_CUES = Object.freeze({
  ...
  confirm:      { src: "/sounds/bt-resume.mp3",       volume: 0.14, rate: 1.05, minGap: 350 },
  task:         { src: "/sounds/bt-complete.mp3",     volume: 0.11, rate: 1.08, minGap: 600 },
  share:        { src: "/sounds/bt-start.mp3",        volume: 0.15, rate: 1.12, minGap: 350 },
});
...
function playSynthFallback(ctx, cue) {
  ...
  } else if (cue === "goal" || cue === "pomodoro" || cue === "complete" || cue === "xp" || cue === "task") {
