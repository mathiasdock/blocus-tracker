        ...
        },
        {
          ...
          body: [
            ...
            { list: [
              ...
              "Si tu actives les notifications : la liste de tes appareils abonnés, tenue dans notre base — un identifiant tiré au hasard par l'appareil lui-même (pas celui de OneSignal), sa famille (iPhone, Android, Mac…) et la date de sa dernière activité —, pour savoir combien de membres une notification peut atteindre. Un appareil est marqué détaché quand tu te déconnectes.",
              "Les notifications qui t'ont été envoyées : leur type, leur date et le résultat de l'envoi, pour ne jamais t'envoyer deux fois le même rappel et en limiter le nombre.",
              "Si l'activation des notifications échoue : un diagnostic technique enregistré dans notre base (version de l'app, système et navigateur, étapes de chargement et durées, sans adresse IP ni email), pour trouver la panne. Lisible par l'équipe uniquement.",
        ...
        },
        {
          ...
          body: [
            { list: [
              ...
              "Rappels d'étude par notification — examen demain ou dans 7 jours, série en danger, aide pour démarrer après l'inscription ou reprendre après une absence ; au plus un par soir et deux relances par semaine, jamais entre 22 h et 8 h dans ton fuseau horaire. Base légale : ton consentement, donné en activant les notifications, révocable en un geste depuis ton profil.",
              "Notifications sociales — demande d'ami reçue ou acceptée, nouveau message privé. Une notification de message ne contient ni le texte ni la pièce jointe : seulement le prénom de l'expéditeur. Base légale : ton consentement aux notifications, avec un refus séparé (« Social ») dans ton profil.",
              "Annonces sur l'app par notification — nouveautés, informations de service. Base légale : ton consentement aux notifications, avec un refus séparé dans ton profil.",
        ...
        },
        {
          ...
          body: [
            ...
            { list: [
              ...
              "OneSignal — notifications push. Reçoit un identifiant d'appareil, ton identifiant Blocus Tracker et le contenu des notifications, uniquement si tu actives les notifications. À la suppression de ton compte, ton identifiant et tous tes abonnements sont aussi effacés chez OneSignal.",
            ]},
        ...
        },
        {
          ...
          body: [
            { list: [
              ...
              "Diagnostic d'échec d'activation des notifications : 30 jours, puis supprimé automatiquement.",
              "Historique des notifications envoyées : 180 jours pour ce qui te concerne ; le bilan de chaque envoi (combien de membres visés, exclus, atteints — sans liste de noms) : un an.",
              "Liste de tes appareils abonnés : un appareil détaché est effacé après 6 mois, un appareil sans activité depuis un an aussi ; tout disparaît avec ton compte.",
        ...
        },
        {
          ...
          body: [
            ...
            { list: [
              ...
              "If you enable notifications: the list of your subscribed devices, kept in our database — an identifier drawn at random by the device itself (not OneSignal's), its family (iPhone, Android, Mac…) and when it was last active — so we know how many members a notification can reach. A device is marked as detached when you sign out.",
              "The notifications sent to you: their type, date and the outcome of the send, so the same reminder never reaches you twice and their number stays limited.",
              "If turning on notifications fails: a technical diagnostic stored in our database (app version, system and browser, loading steps and timings, no IP address or email), to find the fault. Readable by the team only.",
        ...
        },
        {
          ...
          body: [
            { list: [
              ...
              "Study reminders by notification — exam tomorrow or in 7 days, streak at risk, help to get started after signing up or back after a break; at most one an evening and two nudges a week, never between 10 pm and 8 am in your time zone. Legal basis: your consent, given by enabling notifications, withdrawable in one tap from your profile.",
              "Social notifications — friend request received or accepted, new private message. A message notification contains neither the text nor the attachment: only the sender's first name. Legal basis: your consent to notifications, with a separate opt-out (\"Social\") in your profile.",
              "App announcements by notification — news, service information. Legal basis: your consent to notifications, with a separate opt-out in your profile.",
        ...
        },
        {
          ...
          body: [
            ...
            { list: [
              ...
              "OneSignal — push notifications. Receives a device identifier, your Blocus Tracker identifier and the content of notifications, only if you enable notifications. When you delete your account, your identifier and all your subscriptions are erased at OneSignal too.",
            ]},
        ...
        },
        {
          ...
          body: [
            { list: [
              ...
              "Notification activation failure diagnostics: 30 days, then deleted automatically.",
              "History of notifications sent: 180 days for what concerns you; the summary of each send (how many members were targeted, excluded, reached — no list of names): one year.",
              "List of your subscribed devices: a detached device is erased after 6 months, a device inactive for a year too; everything disappears with your account.",
