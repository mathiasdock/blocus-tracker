...
function exportPlan(userId) {
  return [
    ...
    { key: "course_links", table: "course_links", filters: [["user_id", userId]] },
    { key: "course_space_memberships", table: "course_room_members", filters: [["user_id", userId]] },
    { key: "blocked_students", table: "user_blocks", filters: [["blocker_id", userId]] },
    { key: "course_message_reports", table: "course_message_reports", filters: [["reporter_id", userId]] },
    ...
    { key: "streak_freeze_refunds", table: "streak_freeze_refunds", filters: [["user_id", userId]] },
    ...
    // Notifications (v62) : appareils déclarés et envois reçus.
    { key: "push_devices", table: "push_devices", filters: [["user_id", userId]] },
    { key: "notifications_received", table: "notification_recipients", filters: [["user_id", userId]] },
