...
export function computeInsights(sessions, { todaySecs, streak, bestStreak, allTimeSecs, dailyGoalSecs }) {
  ...
  const empty = {
    ...
    sessionCount: 0,
    monthSecs: 0,
    bestWeekday: null, bestWeekdaySecs: 0, weekdaySecs: [0, 0, 0, 0, 0, 0, 0],
  ...
  return {
    ...
    // Exposé pour que le choix d'insight puisse vérifier que le « meilleur
    // jour » se détache vraiment des autres avant de l'annoncer.
    weekdaySecs,
