        ...
        },
        {
          ...
          body: [
            { list: [
              ...
              "Rappels d'étude par notification — examen du lendemain, série en danger, relance douce ; au plus un par jour et quelques relances par semaine, jamais entre 22 h et 8 h dans ton fuseau horaire. Base légale : ton consentement, donné en activant les notifications, révocable en un geste depuis ton profil.",
              "Demandes d'ami par notification. Base légale : ton consentement aux notifications, avec un refus séparé dans ton profil.",
        ...
        },
        {
          ...
          body: [
            { list: [
              ...
              "Study reminders by notification — exam tomorrow, streak at risk, gentle nudge; at most one a day and a few nudges a week, never between 10 pm and 8 am in your time zone. Legal basis: your consent, given by enabling notifications, withdrawable in one tap from your profile.",
              "Friend requests by notification. Legal basis: your consent to notifications, with a separate opt-out in your profile.",
