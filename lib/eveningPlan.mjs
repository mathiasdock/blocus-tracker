...
//   2. série en danger          (relance)
//   3. examen dans 7 jours      (fait)
...
// coupée par l'admin) laisse la place au type suivant — un examen dans
// 7 jours part même si la série en danger est plafonnée.
//
