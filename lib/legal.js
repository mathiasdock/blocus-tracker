        ...
        },
        {
          ...
          body: [
            { list: [
              ...
              "Emails d\u2019actualités et de conseils — uniquement si tu as coché la case correspondante (à l\u2019inscription ou dans ton profil). Ton consentement est distinct de la création de compte : sans lui, tu ne reçois que les emails nécessaires à ton compte. Révocable à tout moment depuis ton profil ou via le lien de désinscription présent dans chaque email.",
            ]},
          ],
        },
        {
          ...
          body: [
            ...
            { list: [
              ...
              "Resend — envoi des emails transactionnels (confirmation, réinitialisation) via Supabase, et, si tu y as consenti, des emails d\u2019actualités et de conseils.",
        ...
        },
        {
          ...
          body: [
            ...
            { list: [
              ...
              "Opposition et retrait du consentement : par exemple désactiver les notifications push, ou te désinscrire des emails d\u2019actualités depuis ton profil ou le lien présent dans chaque email.",
            ]},
        ...
        },
        {
          ...
          body: [
            { list: [
              ...
              "Product news and study tips by email — only if you ticked the corresponding box (at signup or in your profile). This consent is separate from creating an account: without it you only receive the emails your account needs. Revocable at any time from your profile or via the unsubscribe link in every email.",
            ]},
          ],
        },
        {
          ...
          body: [
            ...
            { list: [
              ...
              "Resend — transactional emails (confirmation, reset) via Supabase and, if you consented to them, product news and study tips.",
        ...
        },
        {
          ...
          body: [
            ...
            { list: [
              ...
              "Objection and withdrawal of consent: e.g. disabling push notifications, or unsubscribing from our news emails via your profile or the link in every email.",
            ]},
      ...
      sections: [
        {
          h: "En bref",
          body: [
            "Blocus Tracker n'utilise aucun cookie publicitaire ni traceur tiers, et ne revend aucune donnée. Nous ne te pistons pas à des fins publicitaires. Le seul stockage utilisé sur ton appareil est celui qui est nécessaire au fonctionnement de l'app. Si tu as accepté de recevoir nos emails d'actualités, ils sont envoyés via Resend, qui mesure les ouvertures et les clics pour ces emails uniquement — tu peux t'en retirer à tout moment.",
          ],
        },
        {
      ...
      sections: [
        {
          h: "In short",
          body: [
            "Blocus Tracker uses no advertising cookies and no third-party trackers, and never sells your data. We do not track you for advertising. The only storage used on your device is what the app needs to work. If you opted in to our news emails, they are sent via Resend, which measures opens and clicks for those emails only — you can opt out at any time.",
          ],
        },
        {
          h: "Local storage",
