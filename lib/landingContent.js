...
const CONTENT = {
  fr: {
    ...
    hero: {
      ...
      titleAccents: ["plus clair.", "plus calme.", "plus léger.", "sous contrôle."],
    ...
    manifesto: "Étudier, ce n'est pas travailler plus. C'est savoir où tu vas, et voir tout le chemin déjà parcouru.",
  ...
  en: {
    ...
    hero: {
      ...
      titleAccent: "clearer.",
      titleAccents: ["clearer.", "calmer.", "lighter.", "in control."],
    ...
    manifesto: "Studying isn't about working more. It's knowing where you're going, and seeing how far you've already come.",
