...
//     des documents, préférences de notifications (général, rappels, social,
//     annonces). C'est aussi ce que le serveur lit avant d'envoyer un push :
//     notification_audience (v62), le filtre unique de lib/server/notify.mjs.
//
