...
Les appartenances sont multiples. La synchronisation du profil ajoute l'université, les domaines local/global et le programme disponibles ; changer d'études n'efface pas les anciennes appartenances. Une signature du profil préserve le choix de quitter un espace lors des réouvertures suivantes. Les anciennes valeurs de programme ne sont pas devinées dans la nouvelle taxonomie.
...
Le premier écran organise **Tes espaces / Your spaces** puis **Découvrir / Discover**, sous une recherche et une action de création. Les rangées associent nom, niveau académique, université quand elle s'applique et indicateurs réels d'activité ou de membres. Le panneau ouvert expose son titre, l'appartenance, ses ancêtres et le fil commun. Les espaces plus larges proposés sont limités à deux, choisis parmi les ancêtres et le domaine global correspondant selon leur activité et leurs membres réels. Cette aide reste visible lorsque l'espace compte moins de trois publications récentes ; elle devient un volet replié dans un espace actif. Les sous-espaces restent dans un volet distinct.

La participation occupe une invite de composition, puis des publications séparées par des lignes discrètes plutôt que par une succession de cartes. Le type associe une icône et un mot. Les profils s'ouvrent depuis l'auteur et les réponses dans une feuille. La suppression autorisée à l'auteur ou à l'administrateur reste derrière un overflow natif `details/summary`, suivi de la confirmation du navigateur.

## Responsive behavior and accessibility

À partir de 1024px, la liste et le fil se partagent l'écran : colonne de navigation de 280 à 340px, fil flexible, intervalle de 20px. Sous ce seuil, la liste est une surface continue jusqu'au bas de l'écran, avec un dégagement de défilement sous la navigation flottante. Ouvrir un espace remplace la liste par son fil plein écran avec retour explicite. Le nom de l'espace reste prioritaire dans l'en-tête mobile ; son pictogramme y est masqué. Le fil d'Ariane et les filtres défilent horizontalement au besoin et sont exclus du geste de navigation entre routes.
