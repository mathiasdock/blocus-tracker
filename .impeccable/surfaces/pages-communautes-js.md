...
- Deux groupes : **Tes espaces de cours** (rejoints) puis **Pour tes cours** (issus des correspondances automatiques ou confirmées de ses cours actifs, et des questions à confirmer). Peu de suggestions mises en avant ; jamais d'autre établissement, jamais de recommandation inventée.
...
- Compteurs de membres affichés à partir de 3 seulement ; aucun « 1 étudiant ». Démarrage à froid : une phrase vraie et discrète.
...
FIRST VIEWPORT: Desktop : colonne d'un tiers (titre, recherche, Tes espaces de cours, Pour tes cours), salon plein hauteur à droite, conversation continue, composeur en bas. Mobile : la liste seule, puis le salon plein écran.
